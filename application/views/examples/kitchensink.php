...
<div class="responsive">
	...
	<h3 class="visible-phone">PHONE</h3>
	<h3 class="visible-tablet">TABLET</h3>
	<h3 class="hidden-desktop">PHONE + TABLET</h3>
	<h3 class="visible-desktop">DESKTOP</h3>
</div>
<ul class="mobile-menu visible-phone"><li><a href="#"><span>Menu</span></a></li></ul>
